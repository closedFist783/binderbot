...
cam_mount_y   = 55;    // Y distance from back wall to front face of camera mount
...
module cradle() {
    ...
    translate([(shelf_w - cam_w - 2 * cradle_wall) / 2,
        ...
        // Front lower wall — at cam_mount_y from back wall, holds front face of camera mount
        translate([cradle_wall, cam_mount_y, 0])
